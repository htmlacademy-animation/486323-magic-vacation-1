...
/*!******************************************************!*\
  !*** ./source/js/modules/accent-typography-build.js ***!
  \******************************************************/
/*! exports provided: AccentTypographyBuild, animationTitle, animationDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animationTitle", function() { return animationTitle; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "animationDate", function() { return animationDate; });
...
/* harmony import */ var _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./accent-typography-build */ "./source/js/modules/accent-typography-build.js");
...
class FullPageScroll {
  ...
  addMainTitleAnimation() {
    if (this.activeScreen === 0) {
      ...
      setTimeout(() => {
        _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["animationTitle"].runAnimation();
      }, 500);

      title.addEventListener(`transitionend`, () => {
        _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["animationDate"].runAnimation();
      });
    } else {
      _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["animationTitle"].destroyAnimation();
      _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["animationDate"].destroyAnimation();
    }
  }

  addSectionTitleAnimation() {
    if (this.screenElements[this.activeScreen].id) {
      const animationScreenTitle = new _accent_typography_build__WEBPACK_IMPORTED_MODULE_1__["AccentTypographyBuild"](
